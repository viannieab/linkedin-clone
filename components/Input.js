...
import { Article, BusinessCenter, PhotoSizeSelectActualRounded, VideoCameraBack } from '@mui/icons-material'
  ...
  return (
    <div className="bg-white dark:bg-[#1D2226] rounded-lg p-3 space-y-3 border border-gray-300 dark:border-none">
        ...
        <button className="inputButton group">
          <PhotoSizeSelectActualRounded className="text-blue-400" />
