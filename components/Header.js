  ...
  useEffect(() => setMounted(true), []);
    ...
    <header className="sticky top-0 z-40 bg-white dark:bg-[#1D2226] flex items-center justify-around py-1.5 px-3 focus-within:shadow-lg">
        ...
        {mounted && (
          <>
            {resolvedTheme === "dark" ? (
              <Image src="https://www.iconsdb.com/icons/preview/white/linkedin-3-xl.png" alt='white-logo' width={45} height={45} />
            ) : (
              <Image src="https://content.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Bug.svg.original.svg" alt='blue-logo' width={55} height={55} />
            )}
          </>
        )}
